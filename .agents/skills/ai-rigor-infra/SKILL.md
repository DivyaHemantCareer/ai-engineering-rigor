...
- validation or maintenance only
...
1. Change classification and plan.
2. IaC/script changes.
3. Validation evidence and security checks.
4. Infra decision: `READY` or `NOT READY`, with rationale.
