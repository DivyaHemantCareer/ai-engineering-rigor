...
description: Analyze commit message quality -- check conventional commit format, scope/file alignment, and suggest rewrites. Use when the user asks about commit message quality or conventional commits. Reads team config from .ai-rigor/config.yml.
