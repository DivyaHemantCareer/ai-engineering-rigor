"""TypeScript/Next.js code-review skill (deterministic, non-interactive)."""
...
def _iter_source_files(repo_path: str) -> Iterable[str]:
    for root, _, files in os.walk(repo_path):
        for name in files:
            if name.endswith((".ts", ".tsx", ".js", ".jsx", ".env", ".json")):
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run TypeScript code-review skill")
