...
description: Analyze changed Python functions and identify missing test coverage — suggest specific test cases. Reads ignore patterns from .ai-rigor/config.yml.
