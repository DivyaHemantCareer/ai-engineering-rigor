---
name: ai-rigor-deps
description: Audit dependency changes for security risk — unpinned versions, known vulnerabilities, unnecessary packages. Reads allowed packages from .ai-rigor/config.yml.
allowed-tools: Bash(git *), Bash(pip *), Bash(uv *), Read, Grep, Glob, WebSearch
