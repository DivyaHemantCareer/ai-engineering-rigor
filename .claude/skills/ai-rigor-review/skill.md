...
description: LLM-first code review — accepts a PR link (GitHub/ADO), commit range, or file path. Reviews for security, performance, quality, and correctness with minimal context extraction. Reads team standards from .ai-rigor/standards.md.
allowed-tools: Bash(git *), Bash(gh *), Bash(az *), mcp__ado-o365exchange__repo_get_pull_request_by_id, mcp__ado-o365exchange__repo_get_repo_by_name_or_id, mcp__ado-o365exchange__repo_list_pull_request_threads, mcp__ado__repo_get_pull_request_by_id, mcp__ado__repo_get_repo_by_name_or_id, mcp__ado__repo_list_pull_request_threads, Read, Grep, Glob
