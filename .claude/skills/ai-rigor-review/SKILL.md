...
description: LLM-first code review — accepts a GitHub PR link or number, commit range, or file path. Reviews for security, performance, quality, and correctness with minimal context extraction. Reads team standards from .ai-rigor/standards.md.
